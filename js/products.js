...
const products = [
  /* DAIKIN */
  {
    ...
    variants: [
      {
        label: "0.8HP",
        spec: "FTKE20AVA · 0.8HP Inverter · R32 · 2.0kW · 8–16 sqm",
        srp: "₱30,600",
        price: "₱22,800",
        discount: "-20% OFF",
      ...
      {
        label: "1.0HP",
        spec: "FTKE25AVA · 1.0HP Inverter · R32 · 2.5kW · 10–18 sqm",
        srp: "₱33,600",
        price: "₱26,880",
        discount: "-20% OFF",
        image: "images/daikin/amihan.png",
      ...
      {
        label: "1.5HP",
        spec: "FTKE35AVA · 1.5HP Inverter · R32 · 3.5kW · 15–23 sqm",
        srp: "₱38,900",
        price: "₱31,120",
        discount: "-20% OFF",
        image: "images/daikin/amihan.png",
      ...
      {
        label: "2.0HP",
        spec: "FTKE50AVA · 2.0HP Inverter · R32 · 5.0kW · 22–35 sqm",
        srp: "₱48,500",
        price: "₱38,800",
        discount: "-20% OFF",
        image: "images/daikin/amihan.png",
  ...
  },
  {
    ...
    variants: [
      {
        label: "1.0HP",
        spec: "FTKF25CVM · 1.0HP Inverter · Self-Cleaning · Wi-Fi · R32 · 10–18 sqm",
        srp: "₱36,000",
        price: "₱27,000",
        discount: "-25% OFF",
      ...
      {
        label: "1.5HP",
        spec: "FTKF35CVM · 1.5HP Inverter · Self-Cleaning · Wi-Fi · R32 · 15–23 sqm",
        srp: "₱42,000",
        price: "₱31,500",
        discount: "-25% OFF",
        image: "images/daikin/dSmart.png",
      ...
      {
        label: "2.0HP",
        spec: "FTKF50CVM · 2.0HP Inverter · Self-Cleaning · Wi-Fi · R32 · 22–35 sqm",
        srp: "₱52,000",
        price: "₱39,000",
        discount: "-25% OFF",
        image: "images/daikin/dSmart.png",
      ...
      {
        label: "2.5HP",
        spec: "FTKF60CVM · 2.5HP Inverter · Self-Cleaning · Wi-Fi · R32 · 30–45 sqm",
        srp: "₱62,000",
        price: "₱46,500",
        discount: "-25% OFF",
        image: "images/daikin/dSmart.png",
  ...
  },
  {
    ...
    variants: [
      {
        label: "2.0HP",
        spec: "FTKP50AVL · 2.0HP Inverter · 5-Star Energy · Multi-Fan · R32",
        srp: "₱62,000",
        price: "₱50,840",
        discount: "-18% OFF",
      ...
      {
        label: "2.5HP",
        spec: "FTKP60AVL · 2.5HP Inverter · 5-Star Energy · Multi-Fan · R32",
        srp: "₱72,000",
        price: "₱59,040",
        discount: "-18% OFF",
        image: "images/daikin/dsmartKing.png",
      ...
      {
        label: "3.0HP",
        spec: "FTKP71AVL · 3.0HP Inverter · 5-Star Energy · Multi-Fan · R32",
        srp: "₱88,000",
        price: "₱72,160",
        discount: "-18% OFF",
        image: "images/daikin/dsmartKing.png",
  ...
  /* MIDEA */
  {
    ...
    variants: [
      {
        label: "1.0HP",
        spec: "MSBC-09CRN8 · 1.0HP Non-Inverter · R410A · Turbo Cool · 10–15 sqm",
        srp: "₱30,495",
        price: "₱21,499",
        discount: "-30% OFF",
      ...
      {
        label: "1.5HP",
        spec: "MSBC-12CRN8 · 1.5HP Non-Inverter · Self-Cleaning · Anti-Bacterial · 15–20 sqm",
        srp: "₱31,995",
        price: "₱22,999",
        discount: "-28% OFF",
        image: "images/midea/midea.png",
      ...
      {
        label: "2.0HP",
        spec: "MSBC-18CRN8 · 2.0HP Inverter · Smart App Control · Night Mode · 20–30 sqm",
        srp: "₱40,995",
        price: "₱29,999",
        discount: "-27% OFF",
        image: "images/midea/midea.png",
      ...
      {
        label: "2.5HP",
        spec: "MSBC-24CRN8 · 2.5HP Inverter · Dual Fan Speed · R32 · 28–40 sqm",
        srp: "₱49,395",
        price: "₱34,499",
        discount: "-30% OFF",
        image: "images/midea/midea.png",
      ...
      {
        label: "3.0HP",
        spec: "MSBC-30CRN8 · 3.0HP Inverter · Powerful Cooling · 35–50 sqm",
        srp: "₱74,895",
        price: "₱50,499",
        discount: "-33% OFF",
        image: "images/midea/midea.png",
